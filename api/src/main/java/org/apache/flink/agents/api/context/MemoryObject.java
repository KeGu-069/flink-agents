...
public interface MemoryObject {
    ...
    /**
     * Returns a MemoryObject that represents the data pointed to by the given reference.
     *
     * <p>This method resolves the reference by using its path and is functionally equivalent to
     * calling {@code get(ref.getPath())}.
     *
     * @param ref a reference to a data item in the short-term memory
     * @return a MemoryObject instance pointing to the referenced field. Returns null if the path
     *     within the reference does not exist.
